...
data = {}
resultFilePaths = ['h=5cmL=2h.txt', 'h=5cmL=3h.txt', 'h=5cmL=4h.txt', 'h=5cmL=5h.txt', 'h=5cmL=6h.txt', 'h=6cmL=2h.txt', 'h=6cmL=3h.txt', 'h=6cmL=4h.txt', 'h=6cmL=5h.txt', 'h=6cmL=6h.txt']
