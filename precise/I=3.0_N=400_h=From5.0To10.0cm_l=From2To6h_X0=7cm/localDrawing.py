...
data = {}
resultFilePaths = ['h=5cm_L=10cm.txt', 'h=5cm_L=15cm.txt', 'h=5cm_L=20cm.txt', 'h=5cm_L=25cm.txt', 'h=5cm_L=30cm.txt', 'h=5.5cm_L=10cm.txt', 'h=5.5cm_L=15cm.txt', 'h=6cm_L=10cm.txt', 'h=6cm_L=15cm.txt', 'h=6cm_L=20cm.txt', 'h=6cm_L=25cm.txt', 'h=6cm_L=30cm.txt']
...
for filePath in resultFilePaths:
    ...
    print(f"{filePath.split('.t')[0]}: meanB={meanB*1000}[mT], varRate={varRate*100}[%]")
